...
We concatenate the $X$ and $Y$ spatial dimensions of the sub-tensors so that the decomposition is applied to a 3-tensor.
While we could look for a separable approximation along these dimensions, we found the gain to be minimal.    
