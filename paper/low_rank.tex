...
\mbox{
\subfigure[][]{
\includegraphics[width=0.18\linewidth]{img/common.png} 
\label{fig:common_convolution}
}
\hspace{5mm}
\subfigure[][]{
  \includegraphics[width=0.27\linewidth]{img/monochromatic.png} 
  \label{fig:monochromatic}
}
\hspace{5mm}
\subfigure[][]{
  \includegraphics[width=0.35\linewidth]{img/biclustering.png} 
