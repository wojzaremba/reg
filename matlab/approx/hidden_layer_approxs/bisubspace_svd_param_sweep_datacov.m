...
iratio_list = [0.6, 0.5, 0.4, 0.4, 0.5, 0.6, 0.3, 0.4, 0.35, 0.4];
oratio_list = [0.6, 0.6, 0.5, 0.6, 0.5, 0.5, 0.4, 0.4, 0.4, 0.35];
...
for ii = 2 : length(iratio_list)

    iclust = 2;
    oclust = 2;
    oratio = oratio_list(ii); % (0.6 --> 76), (0.5 --> 64)
    iratio = iratio_list(ii);  % (0.6 --> 78), (0.5 --> 24), (0.4 --> 19)
    ...
    save('generated_mats/layer2_bisubspace_svd_2_2_error_datacov.mat', 'errors', 'rank_codes');
